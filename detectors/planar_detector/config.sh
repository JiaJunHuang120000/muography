...
# CRY Variables
export CRY_num_of_events=(1200000 1200000 1200000)
export generation_height=20 #(m)
export detector_z_offset=0.20 #(m)
export detector_y_offset=0.20 #(m)
export detector_x_offset=0.20 #(m)
export energy_cutoff=(0 0 0) #(GeV)
export input_cry_file="/home/jiajun/muography/hepmc/120M_events.txt"  
...
export number_of_events=(1000000 1000000 1000000) # Events simulated in ddsim
...
export world_depth=50 #(m) dz of the world, should made such is larger than generation_height
...
#"cube   xdim=30*m ydim=500*m zdim=30*m x=0*m  y=0*m  z=-50*m    material=Steel235"
#"sphere r=20*m   x=50*m   y=0*m    z=-50*m    material=Steel235"
